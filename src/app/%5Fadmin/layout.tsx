...
// they ever reach this layout. Role-gated nav items (MCP 연동, 계정 관리)
// live inside AdminTabs now, not here, so this layout no longer needs a
// profile lookup of its own.
